...
const usersMethodObj = {
  ...
  async post(reqData) {
    ...
    const tokenCreationResponse = await new Promise((resolve, reject) => {
      const req = http.request(requestOptions, res => {
        ...
        res.on('end', () => {
          if (res.statusCode === 200) {
            ...
            resolve(helpers.generateResponseObj(res.statusCode, body));
          }

          reject(helpers.errorWrapper('Error creating user token. Please create manually', 500));
        });
      });
