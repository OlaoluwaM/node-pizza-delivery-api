...
// !! Stripe integration removed due to it being unable to use testing mode in live environments
...
const paymentIntentMethods = {
  ...
  //     clientSecret,
  //     updatedCartTotal: totalOnServer,
  //   });
  // },
...
const checkoutHandler = {
  async checkout(data) {
    ...
    try {
      ...
      newAccessToken = await auth.verifyToken(headers, resultObj.email);
      ...
      } else throw new CustomError('Service unavailable', 503);
